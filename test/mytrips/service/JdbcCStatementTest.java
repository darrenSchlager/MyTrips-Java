 ...
 * @author Darren
 */
public class JdbcCStatementTest {
    
    @Test
    public void testStatementServices() throws Exception {
        IUserSvc userImpl = new UserSvcCStatementImpl();
        ILoginSvc loginImpl = new LoginSvcCStatementImpl();
        ITripSvc tripImpl = new TripSvcCStatementImpl();
        ILocationSvc locationImpl = new LocationSvcCStatementImpl();
        IActivitySvc activityImpl = new ActivitySvcCStatementImpl();
